...
public class MovieInfo extends Command {
     ...
     */
    public MovieInfo(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, String subjectId, String authToken) throws CommandException {
    ...
    public void execute() throws CommandException {
        ...
        try {
            ...
            this.smartCityModelService.updateDevice(this.city.getCityId(), this.device.getDeviceId(), this.device, this.authToken);
