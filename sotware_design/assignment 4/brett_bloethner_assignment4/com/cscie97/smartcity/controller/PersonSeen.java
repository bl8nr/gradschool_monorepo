...
public class PersonSeen extends Command {
     ...
     */
    public PersonSeen(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, String subjectId, String authToken) throws CommandException {
    ...
    public void execute() throws CommandException {
        try {
            ...
            this.smartCityModelService.updatePerson(this.subject.getPersonId(), subject, this.authToken);
