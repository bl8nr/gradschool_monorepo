...
public class MissingChild extends Command {
     ...
     */
    public MissingChild(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, String subjectId, String authToken) throws CommandException {
