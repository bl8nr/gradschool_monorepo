...
public class MovieReservation extends Command {
     ...
     */
    public MovieReservation(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, String subjectId, String authToken) throws CommandException {
