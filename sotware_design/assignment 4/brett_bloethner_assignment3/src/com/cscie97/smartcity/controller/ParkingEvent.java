...
public class ParkingEvent extends Command {
     ...
     */
    public ParkingEvent(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, String cityOfVehicle, String idOfVehicle, Integer duration) throws CommandException {
    ...
    public void execute() throws CommandException {
        ...
        try {
            patronVehicle = (Vehicle) this.smartCityModelService.getCityById(this.cityOfVehicle).getDeviceById(this.idOfVehicle);
