...
public class CommandProcessor {
    ...
    private AuthToken currentUserAuthToken;

    public CommandProcessor() {
        smartCityModelService = SmartCityModelService.getInstance();
        smartCityLedgerService = SmartCityLedgerService.getInstance();
        smartCityAuthenticationService = SmartCityAuthenticationService.getInstance();
    }
    ...
    public void processCommand(String command) throws CommandProcessorException {
        ...
        if (this.currentUserAuthToken == null && (!action.equals("login")) && (!action.equals("logout"))) {
            throw new CommandProcessorException("processCommand()", "Failed to process comment. Missing auth token", null);
        }
                    ...
                    switch (subject) {
                        case "city":
                            ...
                            String cityUuid = this.smartCityModelService.createCity(
                                    ...
                                    location,
                                    currentUserAuthToken.getToken());

                            try {
                                this.smartCityLedgerService.createAccount(getRequiredArgumentByKey("account", args));
                            } catch (LedgerException e) {
                                throw new SmartCityModelServiceException("Ledger Account Creation", "Failed to create ledger account");
                            }
                            break;
                        ...
                        case "street-sign":
                            ...
                            smartCityModelService.addDevice(cityIdDeviceId[0], streetSign, currentUserAuthToken.getToken());
                        ...
                        case "info-kiosk":
                            ...
                            smartCityModelService.addDevice(cityIdDeviceId[0], informationKiosk, currentUserAuthToken.getToken());
                        ...
                        case "street-light":
                            ...
                            smartCityModelService.addDevice(cityIdDeviceId[0], streetLight, currentUserAuthToken.getToken());
                        ...
                        case "parking-space":
                            ...
                            smartCityModelService.addDevice(cityIdDeviceId[0], parkingSpace, currentUserAuthToken.getToken());
                        ...
                        case "robot":
                            ...
                            smartCityModelService.addDevice(cityIdDeviceId[0], robot, currentUserAuthToken.getToken());
                        ...
                        case "vehicle":
                            ...
                            smartCityModelService.addDevice(cityIdDeviceId[0], vehicle, currentUserAuthToken.getToken());
                        ...
                        case "resident":
                            ...
                            smartCityModelService.createPerson(resident, this.currentUserAuthToken.getToken());
...
//                            System.out.printf("\nRESIDENT CREATED %s\n", resident.toString());
                        ...
                        case "visitor":
                            ...
                            smartCityModelService.createPerson(visitor, this.currentUserAuthToken.getToken());
                            System.out.printf("\nVISITOR CREATED %s\n", visitor.toString());
                            break;
                ...
                case "update":
                    ...
                    switch (subject) {
                        case "city":
                            ...
                            // update city
                            City updatedCity = this.smartCityModelService.updateCity(args.get(2), this.getRequiredArgumentByKey("account", args), this.currentUserAuthToken.getToken());
                            System.out.printf("\nCITY UPDATED %s %s", args.get(2), updatedCity);
                            break;
                        ...
                        case "street-sign":
                            ...
                            cityIdDeviceId = args.get(2).split(":");
                            StreetSign currentStreetSign = (StreetSign) this.smartCityModelService.getDevice(cityIdDeviceId[0], cityIdDeviceId[1], this.currentUserAuthToken.getToken());
                            ...
                            Device savedUpdatedDevice = smartCityModelService.updateDevice(cityIdDeviceId[0], cityIdDeviceId[1], updatedStreetSign, currentUserAuthToken.getToken());
                            System.out.printf("\nSTREET SIGN UPDATED IN %s %s \n", cityIdDeviceId[0], savedUpdatedDevice);
                            break;
                        case "info-kiosk":

                            // create new info-kiosk from the current info-kiosk
                            cityIdDeviceId = args.get(2).split(":");
                            InformationKiosk currentInformationKiosk = (InformationKiosk) this.smartCityModelService.getDevice(cityIdDeviceId[0], cityIdDeviceId[1], this.currentUserAuthToken.getToken());
                            ...
                            Device savedUpdatedInformationKiosk = smartCityModelService.updateDevice(cityIdDeviceId[0], cityIdDeviceId[1], updatedInformationKiosk, currentUserAuthToken.getToken());
                            System.out.printf("\nINFORMATION KIOSK UPDATED IN %s %s \n", cityIdDeviceId[0], savedUpdatedInformationKiosk);
                            break;
                        case "street-light":

                            // create new street-light from the current street-light
                            cityIdDeviceId = args.get(2).split(":");
                            StreetLight currentStreetLight = (StreetLight) this.smartCityModelService.getDevice(cityIdDeviceId[0], cityIdDeviceId[1], this.currentUserAuthToken.getToken());
                            ...
                            Device savedUpdatedStreetLight = smartCityModelService.updateDevice(cityIdDeviceId[0], cityIdDeviceId[1], updatedStreetLight, currentUserAuthToken.getToken());
                            System.out.printf("\nSTREET LIGHT UPDATED IN %s %s \n", cityIdDeviceId[0], savedUpdatedStreetLight);
                            break;
                        case "parking-space":

                            // create new parking-space from the current parking-space
                            cityIdDeviceId = args.get(2).split(":");
                            ParkingSpace currentParkingSpace = (ParkingSpace) this.smartCityModelService.getDevice(cityIdDeviceId[0], cityIdDeviceId[1], this.currentUserAuthToken.getToken());
                            ...
                            Device savedUpdatedParkingSpace = smartCityModelService.updateDevice(cityIdDeviceId[0], cityIdDeviceId[1], updatedParkingSpace, currentUserAuthToken.getToken());
                            System.out.printf("\nPARKING SPACE UPDATED IN %s %s \n", cityIdDeviceId[0], savedUpdatedParkingSpace);
                            break;
                        case "robot":

                            // create new robot from the current robot
                            cityIdDeviceId = args.get(2).split(":");
                            Robot currentRobot = (Robot) this.smartCityModelService.getDevice(cityIdDeviceId[0], cityIdDeviceId[1], this.currentUserAuthToken.getToken());
                            ...
                            Device savedUpdatedRobot = smartCityModelService.updateDevice(cityIdDeviceId[0], cityIdDeviceId[1], updatedRobot, currentUserAuthToken.getToken());
                            System.out.printf("\nROBOT UPDATED IN %s %s \n", cityIdDeviceId[0], savedUpdatedRobot);
                            break;
                        case "vehicle":

                            // create new vehicle from the current vehicle
                            cityIdDeviceId = args.get(2).split(":");
                            Vehicle currentVehicle = (Vehicle) this.smartCityModelService.getDevice(cityIdDeviceId[0], cityIdDeviceId[1], this.currentUserAuthToken.getToken());
                            ...
                            Device savedUpdatedVehicle = smartCityModelService.updateDevice(cityIdDeviceId[0], cityIdDeviceId[1], updatedVehicle, currentUserAuthToken.getToken());
                            System.out.printf("\nVEHICLE UPDATED IN %s %s \n", cityIdDeviceId[0], savedUpdatedVehicle);
                            break;
                        case "resident":

                            // create new resident from the current resident
                            Resident currentResident = (Resident) this.smartCityModelService.showPerson(args.get(2), this.currentUserAuthToken.getToken());
                            ...
                            Person savedUpdatedResident = smartCityModelService.updatePerson(args.get(2), updatedResident, this.currentUserAuthToken.getToken());
                            System.out.printf("\nRESIDENT UPDATED ID:%s %s\n", args.get(2), savedUpdatedResident);
                            break;
                        case "visitor":

                            // create new visitor from the current street-sign
                            Visitor currentVisitor = (Visitor) this.smartCityModelService.showPerson(args.get(2), this.currentUserAuthToken.getToken());
                            ...
                            Person savedUpdatedVisitor = smartCityModelService.updatePerson(args.get(2), updatedVisitor, this.currentUserAuthToken.getToken());
                            System.out.printf("\nVISITOR UPDATED ID:%s %s \n", args.get(2), savedUpdatedVisitor);
                            break;
                    }
                    break;
                ...
                case "show":
                    ...
                    switch (subject) {
                        case "city":
                            ...
                            City city = this.smartCityModelService.getCityById(args.get(2), this.currentUserAuthToken.getToken());
                            HashMap<String, Device> devicesInCityLimits = this.smartCityModelService.getDevicesInLocation(city.getLocation(), this.currentUserAuthToken.getToken());
                            HashMap<String, Person> personsInCityLimits = this.smartCityModelService.getPersonsInLocation(city.getLocation(), this.currentUserAuthToken.getToken());
                        ...
                        case "device":
                            ...
                            if (cityIdDeviceId.length == 2) {
                                ...
                                Device device = this.smartCityModelService.getDevice(cityIdDeviceId[0], cityIdDeviceId[1], this.currentUserAuthToken.getToken());
                                System.out.printf("\nSHOWING DEVICE INFO FOR ID %s:%s %s \n", cityIdDeviceId[0], device.getDeviceId(), device.toString());
                            } else {
                                // if it only includes a city id, get all the devices registered to that city and print their info
                                HashMap<String, Device> devices = this.smartCityModelService.getDevice(cityIdDeviceId[0], this.currentUserAuthToken.getToken());
                                ...
                                while (deviceIterator.hasNext()) {
                                    ...
                                    System.out.printf("\nSHOWING DEVICE INFO FOR ID %s. Device %s of %s %s\n", cityIdDeviceId[0], counter, devices.size(), deviceEntry.toString());
                                    counter++;
                                }
                            }
                        ...
                        case "person":
                            ...
                            Person result = this.smartCityModelService.showPerson(args.get(2), this.currentUserAuthToken.getToken());
                            System.out.printf("\nSHOWING PERSON INFO FOR ID %s %s\n", args.get(2), result.toString());
                            break;
                ...
                case "create":
                    ...
                    switch (subject) {
                        case "sensor-event":
                            ...
                            System.out.println("EVENT DETAILS: " + args);
                            ...
                            SensorEvent sensorEvent = new SensorEvent(
                                    ...
                                    args.get(2).contains(":") ? args.get(2).split(":")[0] : null,
                                    args.get(2).contains(":") ? args.get(2).split(":")[1] : null,
                                    getArgumentByKey("credential", args)
                            );
                            ...
                            if (args.get(2).contains(":")) {
                                ...
                                cityIdDeviceId = args.get(2).split(":");
                                this.smartCityModelService.createSensorEvent(cityIdDeviceId[0], cityIdDeviceId[1], sensorEvent, this.currentUserAuthToken.getToken());
                                System.out.println("END SENSOR EVENT PROCESSING\n");
                            } else {
                                // if it only includes a city id, then send the sensor event to every device registered in that city
                                this.smartCityModelService.createSensorEvent(args.get(2), sensorEvent, this.currentUserAuthToken.getToken());
                                System.out.println("END SENSOR EVENT PROCESSING\n");
                            }
                        ...
                        case "sensor-output":
                            ...
                            if (args.get(2).contains(":")) {
                                ...
                                this.smartCityModelService.createSensorOutput(cityIdDeviceId[0], cityIdDeviceId[1], sensorOutput, this.currentUserAuthToken.getToken());
                            } else {
                                ...
                                this.smartCityModelService.createSensorOutput(args.get(2), sensorOutput, this.currentUserAuthToken.getToken());
                            }
                ...
                case "define_permission":
                    this.smartCityAuthenticationService.createPermission(args.get(1), args.get(2), args.get(3), currentUserAuthToken.getToken());
                    break;

                case "define_role":
                    this.smartCityAuthenticationService.createRole(args.get(1), args.get(2), args.get(3), this.currentUserAuthToken.getToken());
                    break;

                case "add_permission_to_role":
                    this.smartCityAuthenticationService.addPermissionToRole(args.get(1), args.get(2), this.currentUserAuthToken.getToken());
                    break;

                case "create_user":
                    this.smartCityAuthenticationService.createUser(args.get(1), args.get(2), this.currentUserAuthToken.getToken());
                    break;

                case "add_user_credential":
                    this.smartCityAuthenticationService.updateUserCredential(args.get(1), CredentialType.valueOf(args.get(2).toUpperCase()), args.get(3), this.currentUserAuthToken.getToken());
                    break;

                case "add_role_to_user":
                    this.smartCityAuthenticationService.addRoleToUser(args.get(1), args.get(2), this.currentUserAuthToken.getToken());
                    break;

                case "create_resource_role":
                    this.smartCityAuthenticationService.createResourceRole(args.get(1), args.get(2), args.get(3), this.currentUserAuthToken.getToken());
                    break;

                case "login":
                    this.currentUserAuthToken = this.smartCityAuthenticationService.login(args.get(1), args.get(2));
                    break;

                case "logout":
                    this.smartCityAuthenticationService.logout(args.get(1));
                    break;

                case "print":
                    this.smartCityAuthenticationService.printInventory(this.currentUserAuthToken.getToken());
                    break;
