...
public class EmergencyOne extends Command {
     ...
     */
    public EmergencyOne(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, EmergencyOneTypeEnum emergencyType, String cityId, String deviceId, String authToken) throws CommandException {
    ...
    public void execute() throws CommandException {
        ...
        try {
            this.smartCityModelService.createSensorOutput(this.city.getCityId(), new SensorOutput(SensorOutputTypeEnum.SPEAKER, String.format("There is a %s emergency in %s, please find shelter immediately", emergencyType, this.city.getName())), this.authToken);
