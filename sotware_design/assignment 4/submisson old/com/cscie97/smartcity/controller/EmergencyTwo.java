...
public class EmergencyTwo extends Command {
     ...
     */
    public EmergencyTwo(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, EmergencyTwoTypeEnum emergencyType, String cityId, String deviceId, String authToken) throws CommandException {
