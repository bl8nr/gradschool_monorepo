...
public class BrokenGlass extends Command {
     ...
     * omitted.
     */
    public BrokenGlass(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, String authToken) throws CommandException {
