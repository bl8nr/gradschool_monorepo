...
public class CO2Event extends Command {
     ...
     */
    public CO2Event(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, Boolean isCarsEnabled) throws CommandException {
    ...
    public void execute() throws CommandException {
        ...
        for (Map.Entry<String, Device> entry : this.smartCityModelService.getDevicesInLocation(this.city.getLocation()).entrySet()) {
            ...
            if (v instanceof Vehicle && (((Vehicle) v).getType() == VehicleTypeEnum.CAR)) {
                ...
                try {
                    this.smartCityModelService.updateDevice(city.getCityId(), v.getDeviceId(), v);
