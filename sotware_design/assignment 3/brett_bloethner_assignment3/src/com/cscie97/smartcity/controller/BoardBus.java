...
public class BoardBus extends Command {
     ...
     */
    public BoardBus(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, String subjectId) throws CommandException {
