                ...
                case "define":
                    ...
                    switch (subject) {
                        ...
                        case "street-sign":
                            ...
                            System.out.printf("\nSTREET SIGN CREATED IN CITY %s, %s\n", cityIdDeviceId[0], streetSign.toString());
                            break;
                        ...
                        case "info-kiosk":
                            ...
                            System.out.printf("\nINFORMATION KIOSK CREATED IN CITY %s, %s\n", cityIdDeviceId[0], informationKiosk.toString());
                            break;
                        ...
                        case "street-light":
                            ...
                            System.out.printf("\nSTREET LIGHT CREATED IN CITY %s, %s\n", cityIdDeviceId[0], streetLight.toString());
                            break;
                        ...
                        case "parking-space":
                            ...
                            System.out.printf("\nPARKING SPACE CREATED IN CITY %s, %s\n", cityIdDeviceId[0], parkingSpace.toString());
                            break;
                        ...
                        case "robot":
                            ...
                            System.out.printf("\nROBOT CREATED IN CITY %s, %s\n", cityIdDeviceId[0], robot.toString());
                            break;
                        ...
                        case "vehicle":
                            ...
                            System.out.printf("\nVEHICLE CREATED IN CITY %s, %s\n", cityIdDeviceId[0], vehicle.toString());
                            break;
