...
public class BusRoute extends Command {
     ...
     */
    public BusRoute(SmartCityModelService smartCityModelService, SmartCityLedgerService smartCityLedgerService, String cityId, String deviceId, String subjectId, String locationString) throws CommandException {
